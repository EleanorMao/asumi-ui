        ...
        return (
            <div className="content home">
                ...
                <ul className="fa-ul">
                    ...
                    <li><Icon type="check" li/>Select增加标签</li>
                    <li><Icon type="check" li/>Select样式优化</li>
                    <li><Icon type="check" li/>Select去除closeAfterSelect参数</li>
                    ...
                    <li><Icon type="check" li/>FormItem将component类型，由cloneElement方法修改为createElement方法</li>
                    <li><Icon type="check" li/>Loading新增bounce类型</li>
                    <li><Icon type="check" li/>新增Panel组件</li>
                </ul>
            </div>
        );
    }
