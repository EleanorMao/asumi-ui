    ...
    _createClass(Table, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            this.setState(function (prevState) {
                ...
                var page = (nextProps.pagination || nextProps.topPagination) && nextProps.options.page || _this2.state.currentPage;
        ...
        value: function handleFlip(length) {
            ...
            var page = remote ? getNextPage(options.page, length, dataSize) : this.state.currentPage;
            if (!remote) {
                this.setState(function (prevState) {
        ...
        value: function paginationTotalRender() {
            ...
            if (pagination && options.paginationShowsTotal) {
                ...
                var length = remote ? dataSize : data.length;
                return _react2['default'].createElement(
                    'div',
                    ...
                    options.paginationShowsTotal === true ? _react2['default'].createElement(
                        'div',
                        null,
                        length > 0 ? '\u663E\u793A ' + start + ' \u81F3 ' + to + '\u6761' : '\u663E\u793A 0 \u6761',
                        ' \u5171',
                        length,
                        '\u6761'
        ...
        value: function topPagingRowRender() {
            var _props12 = this.props,
                topPagination = _props12.topPagination,
        ...
        value: function render() {
            ...
            var _props13 = this.props,
                ...
                style = _props13.style,
                isTree = _props13.isTree,
                remote = _props13.remote,
                height = _props13.height,
                striped = _props13.striped,
                children = _props13.children,
                sortName = _props13.sortName,
                lineWrap = _props13.lineWrap,
                selectRow = _props13.selectRow,
                sortOrder = _props13.sortOrder,
                nestedHead = _props13.nestedHead,
                pagination = _props13.pagination,
                topPagination = _props13.topPagination;
