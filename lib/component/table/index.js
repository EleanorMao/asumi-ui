...
var Table = function (_Component) {
    ...
    _createClass(Table, [{
        ...
        value: function _adjustWidth() {
            ...
            var isNoData = refs.tbody.firstChild.childElementCount === 1;
            ...
            var haveScrollBar = refs.body.offsetWidth !== refs.thead._header.offsetWidth;
        ...
        value: function handleToggle(option) {
            ...
            var callback = function callback(data) {
                ...
                if (clickToCloseAll) {
                    childList = _this3._flatten(childList, childrenPropertyName, hashKey, keyName);
                }
                if (!open) {
        ...
        value: function render() {
            ...
            var renderList = (topPagination || pagination) && !remote ? this._sliceData(renderedList, currentPage, length) : renderedList.slice();
            if (selectRow.mode && selectRow.mode !== 'none') {
                checked = !this._getAllValue(renderList.slice(), this._getKeyName()).filter(function (v) {
