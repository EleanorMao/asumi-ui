...
var GridCol = function (_Component) {
    ...
    _createClass(GridCol, [{
        ...
        value: function render() {
            ...
            var _className = (0, _classnames2['default'])('el-col-' + col, inline ? 'el-col-inline' : '', order != undefined ? 'el-col-order-' + order : '', offset != undefined ? 'el-col-offset-' + offset : '', className);
