    ...
    _createClass(Group, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                style = _props.style,
                other = _objectWithoutProperties(_props, ['children', 'defaultStyle', 'style']);
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].Children.map(children, function (elm) {
                    if (!elm) return;
                    return _react2['default'].cloneElement(elm, _extends({ style: (0, _util.extend)({}, defaultStyle, style, elm.props.style) }, other));
                })
            );
        }
    }]);
