    ...
    _createClass(RadioButton, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                others = _objectWithoutProperties(_props, ['disableAll', 'options', 'value', 'onChange', 'style', 'className']);

            var _className = (0, _classnames2['default'])('el-checkbox-button', className);
