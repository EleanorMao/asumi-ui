    ...
    _createClass(DateTime, [{
        ...
        value: function closeCalendar() {
            ...
            this.setState({
                ...
                _this4.props.onBlur(selectedDate || inputValue);
            });
        }
    }, {
        key: 'localMoment',
        ...
        value: function getComponentProps() {
            ...
            this.componentProps.fromThis.forEach(function (name) {
                props[name] = typeof me[name] === 'function' ? me[name].bind(_this5) : me[name];
            });
            return props;
        }
    }, {
        ...
        value: function onInputChange(e) {
            ...
            return this.setState(update, function () {
                return _this6.props.onChange({
                    value: localMoment.isValid() ? localMoment : _this6.state.inputValue,
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                input && _react2['default'].createElement(_input2['default'], { key: 'i', icon: _react2['default'].createElement('i', { className: 'fa fa-calendar-minus-o' }),
