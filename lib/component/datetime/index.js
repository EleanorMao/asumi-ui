    ...
    _createClass(DateTime, [{
        ...
        value: function updateSelectedDate(item, close) {
            ...
            if (updateOn === 'days') {
                ...
                date = _moment2['default'].min(viewDate.clone().set({ month: item.value, date: currentdate.date() }), viewDate.clone().set({ month: item.value }).endOf('month'));
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                input && _react2['default'].createElement(_input2['default'], _extends({ key: 'i', icon: _react2['default'].createElement('i', { className: 'fa fa-calendar-minus-o' }), autoComplete: 'off' }, inputProps, {
