    ...
    _createClass(DateTime, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                input && _react2['default'].createElement(_input2['default'], { key: 'i', icon: _react2['default'].createElement('i', { onClick: this.openCalendar.bind(this), className: 'fa fa-calendar-minus-o' }),
