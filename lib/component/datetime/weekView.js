        ...
        value: function render() {
            ...
            var date = this.props.viewDate,
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            ...
                            { onClick: function onClick(e) {
                                    return updateTime('subtract', 1, 'months');
                                } },
                            '\u2039'
                        )
                    ),
                    _react2['default'].createElement(
                        'th',
                        { key: 's', className: 'el-datetime-switch', onClick: function onClick(e) {
                                return showView('months');
                            }, colSpan: '5', 'data-value': this.props.viewDate.month() },
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            'span',
                            { onClick: function onClick(e) {
                                    return updateTime('add', 1, 'months');
                                } },
                            '\u203A'
                        )
                    )
