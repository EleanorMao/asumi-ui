    ...
    _createClass(WeekView, [{
        ...
        value: function renderTbody() {
            ...
            for (var i = 0; i < 42; i++) {
                ...
                props = {
                    ...
                    className: (0, _classnames2['default'])('el-datetime-week', {
        ...
        value: function renderDays() {
            var _props4 = this.props,
                ...
                updateSelectedDate = _props4.updateSelectedDate,
                isWeek = _props4.isWeek;
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                { className: 'el-datetime-weeks el-datetime-weeks-panel', 'data-value': uid },
                _react2['default'].createElement(
                    'table',
                    null,
                    _react2['default'].createElement(
