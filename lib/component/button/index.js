        ...
        value: function render() {
            ...
            if (href) {
                return _react2['default'].createElement(
                    'a',
                    _extends({}, other, { href: disabled ? 'javascript:;' : href, className: className }),
                    children
                );
            } else {
                return _react2['default'].createElement(
                    'button',
                    _extends({}, other, { type: 'button', className: className, disabled: disabled }),
                    children
                );
            }
        }
...
Button.propTypes = {
    ...
    type: _react.PropTypes.oneOf(['default', 'text', 'danger', 'success', 'primary', 'secondary'])
};
