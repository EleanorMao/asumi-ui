...
var Select = function (_Component) {
    ...
    _createClass(Select, [{
        ...
        value: function render() {
            ...
            var other = _objectWithoutProperties(_props5, ['size', 'style', 'value', 'noMatchText', 'matchCase', 'onMatch', 'searchable', 'selectedAll', 'defaultValue', 'selectedAllText', 'multiple', 'onChange', 'className', 'children']);
