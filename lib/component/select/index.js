...
var Select = function (_Component) {
    ...
    _createClass(Select, [{
        ...
        value: function handleRemoveClass() {
            var child = this.el_select_ul && this.el_select_ul.children && this.el_select_ul.children[this.index];
        ...
        value: function handleToggleInput(focus, e) {
            this.setState(function (prev) {
                prev.focus = focus;
                if (!focus) {
        ...
        value: function optionsRender() {
            ...
            return _react2['default'].createElement(
                'div',
                { className: className, style: dropdownStyle, ref: function ref(c) {
                        _this3.el_select_menu = c;
                    } },
        ...
        value: function render() {
            ...
            var _props7 = this.props,
                ...
                other = _objectWithoutProperties(_props7, ['size', 'style', 'value', 'noMatchText', 'matchCase', 'onMatch', 'onSearch', 'readOnly', 'searchable', 'selectAll', 'defaultValue', 'selectAllText', 'dropdownClassName', 'dropdownStyle', 'multiple', 'onChange', 'className', 'children', 'closeAfterSelect']);
