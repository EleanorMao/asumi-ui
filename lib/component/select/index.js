...
var Select = function (_Component) {
    ...
    _createClass(Select, [{
        ...
        key: 'getData',
        value: function getData(props, init) {
            var data = [],
                renderData = [],
                allValue = [],
                selectedLabel = [],
        ...
        key: 'handleRemovePreSelect',
        value: function handleRemovePreSelect() {
            this.setState({ preSelected: -1 });
        }
    }, {
        key: 'handleAddPreSelect',
        value: function handleAddPreSelect(preSelected) {
            var child = this.el_select_ul && this.el_select_ul.children && this.el_select_ul.children[preSelected];
        ...
        value: function handleSelect(e, value, selected) {
            var _props5 = this.props,
                ...
                closeAfterSelect = _props5.closeAfterSelect;
        ...
        value: function handleSelectAll(e, allValue, selected) {
            var _props6 = this.props,
                ...
                closeAfterSelect = _props6.closeAfterSelect;
        ...
        key: 'hideComponent',
        value: function hideComponent(e) {
            this.handleRemovePreSelect();
        ...
        value: function optionsRender() {
            ...
            var _props7 = this.props,
                ...
                dropdownClassName = _props7.dropdownClassName,
                dropdownStyle = _props7.dropdownStyle,
                noMatchText = _props7.noMatchText;

            var className = (0, _classnames2['default'])("el-select-dropdown", dropdownClassName || "");
            return _react2['default'].createElement(
                ...
                { className: className, style: dropdownStyle,
                    ...
                    ref: function ref(c) {
                        _this2.el_select_menu = c;
                    } },
                _react2['default'].createElement(
                    'ul',
                    { ref: function ref(c) {
                            _this2.el_select_ul = c;
                        } },
                    searchable && data.length && !renderData.length && _react2['default'].createElement(
                        'li',
                    ...
                    renderData.map(function (props, index) {
                        return _react2['default'].createElement(_option2['default'], _extends({}, props, {
                            ...
                            onDisableChange: _this2.handleDisableSelect.bind(_this2),
        ...
        value: function render() {
            ...
            var _props8 = this.props,
                ...
                closeAfterSelect = _props8.closeAfterSelect,
                size = _props8.size,
                style = _props8.style,
                selectAll = _props8.selectAll,
                defaultValue = _props8.defaultValue,
                selectAllText = _props8.selectAllText,
                dropdownClassName = _props8.dropdownClassName,
                tagProps = _props8.tagProps,
                value = _props8.value,
                noMatchText = _props8.noMatchText,
                matchCase = _props8.matchCase,
                onMatch = _props8.onMatch,
                onSearch = _props8.onSearch,
                type = _props8.type,
                dropdownStyle = _props8.dropdownStyle,
                multiple = _props8.multiple,
                onChange = _props8.onChange,
                children = _props8.children,
                other = _objectWithoutProperties(_props8, ['searchable', 'readOnly', 'className', 'closeAfterSelect', 'size', 'style', 'selectAll', 'defaultValue', 'selectAllText', 'dropdownClassName', 'tagProps', 'value', 'noMatchText', 'matchCase', 'onMatch', 'onSearch', 'type', 'dropdownStyle', 'multiple', 'onChange', 'children']);
            ...
            return _react2['default'].createElement(
                ...
                type === "tag" ? _react2['default'].createElement(_tagInput2['default'], _extends({
                    ...
                    onRemove: function onRemove(_ref) {
                        var e = _ref.e,
                            index = _ref.index;
                        return _this3.handleSelect(e, selectedValue[index], false);
                    }
...
Select.propTypes = {
    ...
    type: _propTypes2['default'].oneOf(['tag']),
