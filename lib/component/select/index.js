    ...
    _createClass(Select, [{
        ...
        value: function handleChange(e) {
            ...
            this.setState(function (prev) {
                ...
                var renderData = onMatch ? onMatch(value) : getMatchData(value, matchCase, [].concat(prev.data));
                prev.renderData = renderData || [];
                return prev;
            });
        }
        ...
        value: function handleSelect(e, value, selected) {
            var _props4 = this.props,
                ...
                closeAfterSelect = _props4.closeAfterSelect;
        ...
        value: function render() {
            ...
            var _props7 = this.props,
                ...
                other = _objectWithoutProperties(_props7, ['searchable', 'readOnly', 'className', 'closeAfterSelect', 'size', 'style', 'selectAll', 'defaultValue', 'selectAllText', 'dropdownClassName', 'tagProps', 'value', 'noMatchText', 'matchCase', 'onMatch', 'onSearch', 'type', 'dropdownStyle', 'multiple', 'onChange', 'children']);
            ...
            return _react2['default'].createElement(
                ...
                type === "tag" ? _react2['default'].createElement(_tagInput2['default'], _extends({}, other, {
                    size: size,
                    tagProps: _tagProps,
                    value: selectedLabel,
