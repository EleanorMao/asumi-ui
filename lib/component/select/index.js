    ...
    _createClass(Select, [{
        ...
        value: function optionsRender() {
            ...
            var _props6 = this.props,
                ...
                selectedAllText = _props6.selectedAllText,
        ...
        value: function render() {
            ...
            var _props7 = this.props,
                ...
                selectedAll = _props7.selectedAll,
                defaultValue = _props7.defaultValue,
                selectedAllText = _props7.selectedAllText,
                multiple = _props7.multiple,
                onChange = _props7.onChange,
                className = _props7.className,
                children = _props7.children,
                closeAfterSelect = _props7.closeAfterSelect,
                other = _objectWithoutProperties(_props7, ['size', 'style', 'value', 'noMatchText', 'matchCase', 'onMatch', 'searchable', 'selectedAll', 'defaultValue', 'selectedAllText', 'multiple', 'onChange', 'className', 'children', 'closeAfterSelect']);
