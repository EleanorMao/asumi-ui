    ...
    _createClass(Select, [{
                ...
                _react2['default'].createElement(
                    ...
                    renderData.map(function (props, index) {
                        ...
                        return _react2['default'].createElement(_option2['default'], _extends({}, props, {
                            key: props.value,
                            multiple: multiple,
                            onChange: _this2.handleSelect.bind(_this2, _index),
        ...
        value: function render() {
            ...
            var _props9 = this.props,
                ...
                closeAfterSelect = _props9.closeAfterSelect,
                size = _props9.size,
                style = _props9.style,
                selectAll = _props9.selectAll,
                defaultValue = _props9.defaultValue,
                selectAllText = _props9.selectAllText,
                dropdownClassName = _props9.dropdownClassName,
                tagProps = _props9.tagProps,
                value = _props9.value,
                noMatchText = _props9.noMatchText,
                matchCase = _props9.matchCase,
                onMatch = _props9.onMatch,
                ...
                other = _objectWithoutProperties(_props9, ['searchable', 'readOnly', 'className', 'closeAfterSelect', 'size', 'style', 'selectAll', 'defaultValue', 'selectAllText', 'dropdownClassName', 'tagProps', 'value', 'noMatchText', 'matchCase', 'onMatch', 'onSearch', 'mode', 'dropdownStyle', 'multiple', 'onChange', 'children']);
