    ...
    _createClass(Select, [{
        ...
        value: function hideComponent(e) {
            ...
            this.setState(function (prev) {
                ...
                prev.renderValue = selectAll && selectAllText && _this3.isSelectAll(prev.selectedValue) ? selectAllText : prev.selectedLabel.join(", ");
                return prev;
            });
        ...
        value: function optionsRender() {
            ...
            return _react2['default'].createElement(
                ...
                { className: className, style: dropdownStyle,
                    ...
                    ref: function ref(c) {
                        _this4.el_select_menu = c;
                    } },
                _react2['default'].createElement(
                    'ul',
                    { ref: function ref(c) {
                            _this4.el_select_ul = c;
                        } },
                    ...
                    renderData.map(function (props, index) {
                        ...
                        return _react2['default'].createElement(_option2['default'], _extends({}, props, {
                            key: props.value,
                            multiple: multiple,
                            onChange: _this4.handleSelect.bind(_this4, _index),
                            selected: !!~selectedValue.indexOf(props.value),
                            onDisableChange: _this4.handleDisableSelect.bind(_this4),
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                mode === "tag" ? _react2['default'].createElement(_tagInput2['default'], _extends({
                    ref: function ref(c) {
                        return _this5._el_select_tag_input = c;
                    },
                    ...
                    onRemove: function onRemove(_ref) {
                        var e = _ref.e,
                            index = _ref.index;
                        return _this5.handleSelect(index, e, selectedValue[index], false);
                    }
                    ...
                    ref: function ref(c) {
                        return _this5._el_select_input = c;
                    },
                    onFocus: this.handleFocus.bind(this),
