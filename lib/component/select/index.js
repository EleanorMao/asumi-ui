    ...
    _createClass(Select, [{
        ...
        value: function getData(props) {
            ...
            _react2['default'].Children.map(children, function (elm) {
                ...
                data.push({ value: value, disabled: disabled, label: children });
                renderData.push({ value: value, disabled: disabled, label: children });
            });
            this.setState({
                data: data,
                allValue: allValue,
        ...
        value: function getPosition() {
            ...
            var _refs$elSelect$getBo = this.refs['el-select'].getBoundingClientRect();

            var top = _refs$elSelect$getBo.top;
            var left = _refs$elSelect$getBo.left;
            var bottom = _refs$elSelect$getBo.bottom;
            var width = _refs$elSelect$getBo.width;
        ...
        value: function handleClose(e) {
            if (this.state.visible && this.refs && this.refs['el-select'] && !(0, _util.contains)(this.refs['el-select'], e.target)) {
                this.hideComponent();
            }
        }
    }, {
        ...
        value: function render() {
            ...
            var other = _objectWithoutProperties(_props5, ['size', 'style', 'value', 'noMatchText', 'matchCase', 'searchable', 'selectedAll', 'defaultValue', 'multiple', 'onChange', 'className', 'children']);

            var _className = (0, _classnames2['default'])('el-select-wrapper', className, size ? 'el-' + size : '');
            return _react2['default'].createElement(
                'div',
                { className: _className, style: style, ref: 'el-select' },
...
Select.propTypes = {
    ...
    matchCase: _react.PropTypes.bool,
    searchable: _react.PropTypes.bool,
    selectedAll: _react.PropTypes.bool,
    onSelectedAll: _react.PropTypes.func,
    noMatchText: _react.PropTypes.string,
