    ...
    _createClass(CheckGroup, [{
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                ...
                others = _objectWithoutProperties(_props3, ['disableAll', 'options', 'style', 'checkAllLabel', 'className', 'min', 'max', 'value', 'hasCheckAll', 'onChange']);
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    this.hasCheckAll && _react2['default'].createElement(_checkbox2['default'], _extends({}, others, {
                        label: checkAllLabel,
                        disabled: disableAll,
                ...
                _react2['default'].createElement(
                    ...
                    options && options.map(function (item, index) {
                        ...
                        return _react2['default'].createElement(_checkbox2['default'], _extends({}, others, {
                            key: index,
                            disabled: disableAll,
        ...
        key: 'getValueFromOptions',
        get: function get() {
            var output = [];
            this.props.options && this.props.options.forEach(function (c) {
                if (c.checked) {
                    output.push(c.value);
                }
            });
