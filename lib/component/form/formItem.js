...
FormItem.propTypes = {
    ...
    type: _propTypes2['default'].oneOf(['text', 'color', 'editor', 'static', 'datetime', 'component', 'password', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'uploader', 'radiogroup', 'checkgroup'])
};
