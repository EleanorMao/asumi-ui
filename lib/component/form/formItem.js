    ...
    _createClass(FormItem, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (!this._pending && beforeSubmit) {
                ...
                formValidator && formValidator(nextProps, this.isDisabled, function () {
        ...
        value: function handleBlur(e) {
            ...
            var valueType = (0, _util.getType)(_value);
            var func = validateMap[valueType];
...
FormItem.propTypes = {
    ...
    type: _propTypes2['default'].oneOf(['text', 'color', 'editor', 'static', 'datetime', 'number', 'component', 'password', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'upload', 'radiogroup', 'checkgroup', 'checkboxgroup', 'transfer', 'taginput', 'hidden'])
};
