    ...
    _createClass(FormItem, [{
        ...
        value: function itemRender() {
            var _props3 = this.props,
                ...
                config = _objectWithoutProperties(_props3, ['on', 'off', 'tips', 'name', 'data', 'component', 'className', 'type', 'onBlur', 'beforeSubmit', 'onChange', 'children', 'options', 'validate', 'validateType', 'validator']);
        ...
        value: function render() {
            ...
            var _props4 = this.props,
                ...
                validateType = _props4.validateType,
                labelWidth = _props4.labelWidth;

            var _className = (0, _classnames2['default'])('el-form-item', 'clearfix', message ? 'el-form-item-' + validateType : '', className);
