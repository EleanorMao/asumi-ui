...
var FormItem = function (_Component) {
    ...
    _createClass(FormItem, [{
        ...
        value: function validator(item, value) {
            ...
            var valueType = Object.prototype.toString.call(value).toLowerCase().slice(8, -1);
...
FormItem.propTypes = {
    ...
    type: _propTypes2['default'].oneOf(['text', 'color', 'editor', 'static', 'datetime', 'number', 'component', 'password', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'upload', 'radiogroup', 'checkgroup', 'checkboxgroup', 'transfer'])
};
