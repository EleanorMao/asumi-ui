    ...
    _createClass(FormItem, [{
        ...
        value: function itemRender() {
            var _props3 = this.props,
                ...
                config = _objectWithoutProperties(_props3, ['on', 'off', 'tips', 'col', 'name', 'data', 'component', 'className', 'dataFormat', 'content', 'value', 'type', 'onBlur', 'beforeSubmit', 'onChange', 'children', 'options', 'validate', 'validateType', 'validator', 'labelWidth']);
...
FormItem.propTypes = {
    ...
    type: _propTypes2['default'].oneOf(['text', 'color', 'static', 'datetime', 'component', 'password', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'uploader', 'radiogroup', 'checkgroup'])
};
