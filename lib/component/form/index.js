            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].Children.map(_children, function (elm, index) {
                    if (elm && elm.type && elm.type.name === "FormItem") {
                        var props = elm.props;
                        return _react2['default'].cloneElement(elm, (0, _util.extend)({
                            key: index,
                            colon: colon,
                            labelWidth: labelWidth,
                            onChange: _this3.handleChange.bind(_this3, props)
...
Form.propTypes = {
    ...
    options: _propTypes2['default'].arrayOf(_propTypes2['default'].shape({
        ...
        type: _propTypes2['default'].oneOf(['text', 'color', 'password', 'datetime', 'static', 'component', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'uploader', 'radiogroup', 'checkgroup'])
    })),
