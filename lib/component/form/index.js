...
Form.propTypes = {
    ...
    options: _propTypes2['default'].arrayOf(_propTypes2['default'].shape({
        ...
        type: _propTypes2['default'].oneOf(['text', 'color', 'password', 'datetime', 'number', 'static', 'component', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'upload', 'radiogroup', 'checkgroup', 'checkboxgroup', 'transfer'])
    })),
