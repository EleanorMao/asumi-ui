    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                ...
                other = _objectWithoutProperties(_props3, ['data', 'options', 'colNum', 'error', 'colon', 'disabled', 'labelWidth', 'hideSubmitButton', 'layout', 'title', 'className', 'submitText', 'submitItems', 'submitButtonOptions', 'children']);
            ...
            return _react2['default'].createElement(
                'form',
                _extends({ className: _className }, other),
...
Form.propTypes = {
    ...
    options: _propTypes2['default'].arrayOf(_propTypes2['default'].shape({
        ...
        type: _propTypes2['default'].oneOf(['text', 'color', 'password', 'datetime', 'number', 'static', 'component', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'upload', 'radiogroup', 'checkgroup'])
    })),
