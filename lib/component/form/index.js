    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                ...
                submitButtonOptions = _props3.submitButtonOptions,
                children = _props3.children;

            var col = colNum ? Math.ceil(12 / colNum) : 0;
            var _disabled = this.state.disabled || disabled;
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].Children.map(_children, function (elm, index) {
                    if (elm && elm.type && elm.type.name === "FormItem") {
                        var props = (0, _util.extend)({
                            colon: colon,
                            labelWidth: labelWidth,
                            onChange: _this3.handleChange.bind(_this3, elm.props)
                        }, elm.props, {
                            col: col,
                            required: isRequired(elm.props),
                            beforeSubmit: _this3.state.beforeSubmit,
                            data: elm.props ? data[elm.props.name] : undefined,
                            validator: _this3.handleDisabled.bind(_this3, elm.props)
                        });
                        return _react2['default'].cloneElement(elm, props);
                    } else {
...
Form.propTypes = {
    ...
    options: _propTypes2['default'].arrayOf(_propTypes2['default'].shape({
        ...
        validate: _propTypes2['default'].arrayOf(_propTypes2['default'].shape({
            ...
            min: _propTypes2['default'].oneOf([_propTypes2['default'].string, _propTypes2['default'].number]),
        ...
        type: _propTypes2['default'].oneOf(['text', 'color', 'password', 'datetime', 'static', 'component', 'textarea', 'select', 'checkbox', 'radio', 'switch', 'upload', 'radiogroup', 'checkgroup'])
    })),
