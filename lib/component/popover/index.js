    ...
    _createClass(Wrap, [{
        ...
        value: function getPosition() {
            ...
            var _ReactDOM$findDOMNode = _reactDom2['default'].findDOMNode(this).getBoundingClientRect(),
                ...
                bottom = _ReactDOM$findDOMNode.bottom,
        ...
        value: function renderComponent() {
            ...
            _reactDom2['default'].unstable_renderSubtreeIntoContainer(this, _react2['default'].createElement(_popover2['default'], props), this.container);
            this.addStyle();
            this.visible = true;
        }
    }, {
...
Wrap.propTypes = {
    ...
    hideTrigger: _propTypes2['default'].oneOf(['click', 'hover']),
