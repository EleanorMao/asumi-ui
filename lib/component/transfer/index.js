    ...
    _createClass(Transfer, [{
        ...
        value: function addToLeft() {
            ...
            this.setState({ leftChecked: [], rightChecked: [] }, function () {
                return _this2.props.onChange({ value: currentValue, name: name });
            });
        }
    }, {
        key: 'addToRight',
        value: function addToRight() {
            ...
            this.setState({ rightChecked: [], leftChecked: [] }, function () {
                return _this3.props.onChange({ value: currentValue, name: name });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            var _props3 = this.props,
                data = _props3.data,
                titles = _props3.titles,
                others = _objectWithoutProperties(_props3, ['data', 'titles']);
        ...
        get: function get() {
            ...
            return data.filter(function (item) {
                return !~value.indexOf(item[propsAlias.value]);
            });
        }
    }, {
        key: 'targetData',
