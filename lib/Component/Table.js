    ...
    _createClass(TreeTable, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            this.setState(function (prevState) {
                ...
                prevState.currentPage = nextProps.pagination && nextProps.options.page || _this2.state.currentPage;
                return prevState;
            });
        }
    }, {
        ...
        value: function colgroupRender(data, mode) {
            var output = [];
            if (mode !== 'none') {
                output.push(_react2.default.createElement('col', { key: 'select', style: { textAlign: 'center', width: 36 } }));
            }
        ...
        value: function render() {
            ...
            var isKey = _props8.isKey;
            var remote = _props8.remote;
            var height = _props8.height;
            var children = _props8.children;
            var sortName = _props8.sortName;
            var lineWrap = _props8.lineWrap;
            var selectRow = _props8.selectRow;
            var sortOrder = _props8.sortOrder;
            var nestedHead = _props8.nestedHead;
            ...
            var checked = false;
            var renderList = pagination && !remote ? this._sliceData(data, currentPage, length) : data.slice();
            if (selectRow.mode !== 'none') {
